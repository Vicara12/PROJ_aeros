...
v0 = 300/3.6;             % Initial velocity [m/s]
g = 9.81;                 % Gravity [N/kg]
...
% 1-2 position
BC_12 = [0 0 v0]; 
gamma_12(:,1) = zeros(N,1);
time_12(1:N,1) = linspace(0,t12,N);
[x_12,h_12,v_12,Cl_12,Cd_12] = straight_flight(rho,T12,g,S,Cd0,k,m*g,0,1,1,time_12,BC_12);
